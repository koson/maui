...
/* Unmerged change from project 'Essentials.DeviceTests(net8.0-windows10.0.19041)'
Before:
				Assert.Equal(-1.0, Battery.ChargeLevel);
After:
			{
...
/* Unmerged change from project 'Essentials.DeviceTests(net8.0-windows10.0.20348)'
Before:
				Assert.Equal(-1.0, Battery.ChargeLevel);
After:
			{
